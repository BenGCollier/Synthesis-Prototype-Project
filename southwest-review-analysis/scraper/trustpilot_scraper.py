...
def scrape_trustpilot_reviews(url, num_pages=5, output_file="data/raw_reviews/southwest_reviews.csv", max_reviews=None):
    headers = {
...
if __name__ == "__main__":
    ...
    scrape_trustpilot_reviews(trustpilot_url, max_reviews=50)
